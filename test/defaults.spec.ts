...
describe('defaults', () => {
  ...
  test('should transform request json', () => {
    let transform: AxiosTransformer = (axios.defaults.transformRequest as Array<AxiosTransformer>)[0]
  ...
  test('should transform response json', () => {
    let transform: AxiosTransformer = (axios.defaults.transformResponse as Array<AxiosTransformer>)[0]
    const data = transform('{"foo":"bar"}')
  ...
  test('shoudl use global defaults conifg', () => {
    axios('/foo')
  ...
  test('should use request conifg', () => {
    axios('/foo', {
  ...
  test('should not be used by custom if set after instance create', () => {
    const instance = axios.create()
    axios.defaults.baseURL = 'http://example/org'
    instance.get('/foo')
    return getAjaxRequest().then(request => {
