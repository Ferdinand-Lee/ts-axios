...
describe('instance', () => {
  ...
  test('should make get http request', () => {
    const instance = axios.create()
    instance.get('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('should make post http request', () => {
    const instance = axios.create()
    instance.post('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('should make put http request', () => {
    const instance = axios.create()
    instance.put('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('should make patch http request', () => {
    const instance = axios.create()
    instance.patch('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('should make options http request', () => {
    const instance = axios.create()
  ...
  test('should make head http request', () => {
    const instance = axios.create()
    instance.head('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('should make delete http request', () => {
    const instance = axios.create()
    instance.delete('/foo')
    return getAjaxRequest().then(request => {
      expect(request.url).toBe('/foo')
  ...
  test('shouldget the computed uri', () => {
    ...
    expect(axios.getUri(fakeConfig)).toBe('https://www.baidu.com/user/123456?idClient=1&idTest=2&testString=thisIsATest')
  })
})